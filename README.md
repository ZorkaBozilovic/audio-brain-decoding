...
**Key Features:**
- Audio synthesis using PrettyMIDI
- Automatic amplitude normalization and silence trimming
- Batch processing of all stimulus files

**Output:** 10 WAV files (`1.wav` through `10.wav`) with consistent audio properties in `diliBach_wav_4dryad/` directory
...
1. **EEG Preprocessing**
   ...
   - Bandpass filtering (4 frequency bands: delta 1-4Hz, theta 4-8Hz, alpha 8-12Hz, beta 12-30Hz)
